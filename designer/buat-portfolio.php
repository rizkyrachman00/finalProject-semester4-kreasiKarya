              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="POST" action="controller/designer_crud.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label for="formGroupExampleInput2">Portfolio</label>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body scrollable">
                ...
                <div class="m-t-30">
                  ...
                  <div class="d-flex m-b-30">
                    <div class="avatar avatar-image">
                      <img src="../assets-enlink/images/avatars/thumb-1.jpg" alt="" />
                    </div>
                    <div class="m-l-15">
                      <a
                        href="javascript:void(0);"
                  ...
                  <div class="d-flex m-b-30">
                    <div class="avatar avatar-image">
                      <img src="../assets-enlink/images/avatars/thumb-2.jpg" alt="" />
                    </div>
                    <div class="m-l-15">
                      <a
                        href="javascript:void(0);"
                ...
                <div class="m-t-30">
                  ...
                  <div class="d-flex m-b-30">
                    <div class="avatar avatar-image">
                      <img src="../assets-enlink/images/others/img-1.jpg" alt="" />
                    </div>
                    <div class="m-l-15">
                      <a
                        href="javascript:void(0);"
