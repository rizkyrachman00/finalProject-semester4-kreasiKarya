            ...
            <div class="page-header no-gutters">
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="POST" action="controller/user_crud.php" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input
                      required
                      value="<?= $row['judul_pekerjaan']?>"
                      name="judul_pekerjaan"
                        type="text"
                        class="form-control"
                        id="formGroupExampleInput"
                        placeholder="<?= $row['gaji']?>"
                      />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="formGroupExampleInput2">Tangal Mulai</label>
                      <input
                      ...
                      name="tgl_mulai"
                        ...
                        class="form-control"
                        id="formGroupExampleInput2"
                        placeholder="<?= $row['tanggal_mulai']?>"
                      />
                    </div>
                    <div class="form-group">
                      <label for="formGroupExampleInput2">Tangal Akhir</label>
                      <input
                      required
                      name="tgl_akhir"
                    ...
                    <div class="form-group">
                      ...
                      >
                      <textarea
                      placeholder="<?= $row['deskripsi_pekerjaan']?>"
                      value="<?= $row['deskripsi_pekerjaan']?>"
                      required
                    ...
                    <div class="form-group">
                      <label for="formGroupExampleInput2">Foto Pekerjaan</label>
                      <div class="custom-file">
                        <input
           
                        name="gambar_pekerjaan"
                          type="file"
                    ...
                    <input type="text" hidden name="id_pekerjaan" value="<?= $row['id_pekerjaan']?>">
                    <button type="submit" 
